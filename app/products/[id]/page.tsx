  ...
  return (
    <div className='product-container'>
                    ...
                    <div className='flex flex-col gap-4'>
                        <div className='flex gap-3'>
                            <div className='product-stars'>
                                <Image src={'/assets/icons/star.svg'} alt='start' width={16} height={16} />
                                <p className='text-sm text-primary-orange'>{product.stars || 25}</p>
                            </div>
                            <div className='product-reviews'>
                                <Image src={'/assets/icons/comment.svg'} width={16} height={16} alt='comment'/>
        ...
        <div className='flex flex-col gap-16 '>
            ...
            <button className='btn w-fit mx-auto flex items-center gap-3 justify-center min-w-[200px]'>
